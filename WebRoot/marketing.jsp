		...
		<div class="main">
			<h1 class="w3layouts_head">Please Submit Budget</h1>
				<div class="w3layouts_main_grid">
					<form action="MarketingDetails.jsp" method="post" class="w3_form_post">
						<div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
								<label>Purchasing </label>
								<input type="text" name="purchasing" placeholder="Purchasing" required="">
							</span>
						</div>
						<div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
						...
						<div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
								<label>Review Expanses</label>
								<input type="text" name="reviewExpanses" placeholder="Review Expanses" required="">
								</span>
						</div>
						<div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
