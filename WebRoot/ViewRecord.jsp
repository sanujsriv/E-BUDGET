...
String query2=null;
String myr=null;
String var=session.getAttribute("session").toString();
...
String year=request.getParameter("year");
	...
	query2="select sum(raw_materials) as raw_materials,sum(machines) as machines,sum(packing) as packing,sum(miscellaneous) as miscellaneous from production where date like '%"+year+"';";
		...
		query2="select sum(purchasing) as purchasing,sum(promotion) as promotion,sum(review_expenses) as review_expenses,sum(miscellaneous) as miscellaneous from marketing where date like '%"+year+"';";
		}
