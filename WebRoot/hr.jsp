...
<!-- banner -->
	<div class="center-container">
		<div class="main">
			<h1 class="w3layouts_head">Please Submit Budget</h1>
				<div class="w3layouts_main_grid">
					<form action="HRDetails.jsp" method="post" class="w3_form_post">
						<div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
								<label>Appraisal </label>
								<input type="text" name="appraisal" placeholder="Appraisal" required="">
							</span>
						</div>
						<div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
								<label>Incentives </label>
								<input type="text" name="incentives" placeholder="Incentives" required="">
							</span>
						</div>
						<div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
						...
						<div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
								...
								<input type="text" name="recruitment" placeholder="Recruitment" required="">
								</span>
						</div>
                        <div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
								<label>Advertisement</label>
								<input type="text" name="advertisement" placeholder="Advertisement" required="">
								</span>
						</div>
                        <div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
								<label>Miscellaneous</label>
								<input type="text" name="miscellaneous" placeholder="Miscellaneous" required="">
								</span>
						</div>
		...
		<!-- Calendar -->
			<link rel="stylesheet" href="about_files/css/jquery-ui.css" />
				<script src="about_files/js/jquery-ui.js"></script>
					<script>
						$(function() {
