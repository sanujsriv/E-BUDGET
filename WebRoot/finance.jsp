		...
		<div class="main">
			<h1 class="w3layouts_head">Please Submit Budget</h1>
				<div class="w3layouts_main_grid">
					<form action="FinanceDetails.jsp" method="post" class="w3_form_post">
                        ...
                        <div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
								<label>Taxes</label>
								<input type="text" name="taxes" placeholder="Taxes" required="">
							</span>
						</div>
                        <div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
								<label>Bills</label>
								<input type="text" name="bills" placeholder="Bills" required="">
							</span>
						</div>
                        ...
                        <div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
								...
								<input type="text" name="insurance" placeholder="Insurance" required="">
							</span>
						</div>
                        <div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
								<label>Rents</label>
								<input type="text" name="rents" placeholder="Rents" required="">
							</span>
						</div>
